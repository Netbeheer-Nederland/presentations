...
1. [MS] Belastingprofiel
2. [LS] Belastingprofiel
3. [LS] Belasting "achter de meter"
...
1. [MS] Koppeling tussen stations
...
1. [MS] Fysieke locatie station & afnemer
...
gantt
    ...
    section LS
    Liander (Buurtnet, 2) :2026-07-01, 90d
----

1. [MS] Projectinformatie
2. [LS] Projectinformatie
